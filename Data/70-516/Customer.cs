...
namespace _70_516
{
    ...
    public partial class Customer: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<CustomerDemographic> CustomerDemographics
        {
            get
            {
                if (_customerDemographics == null)
                {
                    _customerDemographics = new TrackableCollection<CustomerDemographic>();
        ...
        private TrackableCollection<CustomerDemographic> _customerDemographics;
